...
public class EvolutionLogger {
    ...
    public ArrayList<double[]> solutions;

    // these are the one proposed as best yet

    public ArrayList<double[]> bestYetSolutions;
    ...
    public void log(double fitness, double[] solution, boolean isOptimal) {
...
//            listener.update(this, solution, fitness);
    ...
    */
    public void keepBest(double[] sol, double fitness) {
        this.finalSolution = sol;
        this.finalFitness = fitness;
        // System.out.println("Called keep best");
    }

    public void logBestYest(double[] solution) {
